    ...
    <TwoContent className="py-5 md:py-0 gap-5 md:gap-0" id="about">
      ...
      <div className="col-start-1 row-start-2 md:row-start-1 md:col-start-2 lg:col-end-4">
        <div className="px-5 md:py-10 text-sm md:text-base">
            ...
            I am a person who is very curious and always want to learn new things, I also very passionate about the tech field, I am always looking for new challenges and opportunities to improve my skills and knowledge. Recently, I <strong>successfully</strong> implement what I learn to make real project for my client to create invitation website. <br /><br />
